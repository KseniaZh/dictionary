...
export function* workerStart_EltypeClass_GET_RequestServer() {

    const url = yield select(state => state.stateUrl.url_EltypeClass);
...
export function* watch_EltypeClass_GET_RequestServer(){
    ...
    yield takeEvery(START_GET_REQUEST, workerStart_EltypeClass_GET_RequestServer)
}